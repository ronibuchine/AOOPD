...
public class BitArray implements Clusterable<BitArray> {
	...
	public double distance(BitArray other) {
		...
		// every matching index is marked as 0, non=matching index marked as 1, so the
		// sum returned is the hamming distance
	...
	public static Set<BitArray> readClusterableSet(String path) throws IOException {
		...
		// of the lines that are of the length found above, construct BitArrays from
		// them and add them to a set
